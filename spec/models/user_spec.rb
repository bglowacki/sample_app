...
describe User do
  ...
  describe "when emaiil is not present" do
    before {@user.email = " "}
    it {should_not be_valid}
  end
  ...
  describe "when the email format is vaild" do
  ...
  describe "when the password mismatch" do
    before {@user.password_confirmation = "mismatch" }
    it{should_not be_valid}
  end

  describe "with a password too shor" do
